...
{
    public class GH_MD_Strikethrough : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GH_MD_Strikethrough class.
        /// </summary>
        public GH_MD_Strikethrough()
          : base("Markdown* Strikethrough", "MD* Strike",
              "Apply Markdown Strikethrough decorators. Only for Extended Markdown.",
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.MdPlus_Strikethrough;
            }
        }
        ...
        {
            get { return new Guid("CAAFDD3C-3787-476E-BD4E-99F0A409362A"); }
        }
    }
}