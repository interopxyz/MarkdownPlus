...
{
    public class GH_MD_Link : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GH_MD_Link class.
        /// </summary>
        public GH_MD_Link()
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddTextParameter("Hyperlink", "L", "The Hyperlink text", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            DA.SetData(0, "[" + content+"]("+hyperlink+")");
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.MdPlus_Link;
            }
        }
        ...
        {
            get { return new Guid("575E1B9C-2B41-4CFB-A8CC-8893526B7B9F"); }
        }
    }
}